...
if args.outdir == './pb11_diags':
    ...
    OUTDIR     = (f'./runs/pb11_3d_pilot_{mode_tag}_base_{base_tag}'
...
if rank == 0:
    print('=' * 70)
    print('  p-11B/p-7Li/LiB RING RECONNECTION  v12.14-3D-PILOT-v1 (Harris By topology restored)')
    print('=' * 70)
...
def build_Jy(rotating=False):
    ...
    # Rotating drive: small Jy perturbation following spot positions
...
if args.no_bfield:
    ...
    By_expr_str = build_By_expression()
    if rank == 0:
        by_preview = By_expr_str[:120].replace('\n',' ')
...
if rank == 0:
    with open(META_FILE, 'w', encoding='utf-8') as fh:
        fh.write('v12.14-3D-PILOT-v1 per-region fuel config run metadata\n' + '='*60 + '\n')
